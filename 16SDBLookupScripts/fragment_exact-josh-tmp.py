...
class Fragment:
    ...
    def __init__(self):
        ...
        self.f240 = {}
        self.f250 = {}
        self.iTAG926f = set(['AAACTCAAAGGAATTGACGG',
    ...
    def idhit(self, id, seq, primerDict):
        for primer in primerDict:
            if primer in seq:
                ind = str(seq).index(primer)
    ...
    def idhitWrapper(self, id, seq, primer):
        primerDict = {}
    ...
    def read(self,
        ...
        with open("primer_misses.fa", "w") as primer_misses_out:
            for entry in entries.keys():
                hit = self.idhitWrapper(entry, str(entries[entry]),primer)
                if hit:
                    primer_hits+=1
                elif not hit:
                    primer_miss+=1
